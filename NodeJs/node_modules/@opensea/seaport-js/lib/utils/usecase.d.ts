...
export declare const getTransactionMethods: <T extends BaseContract, U extends keyof T>(signer: Signer | Promise<Signer>, contract: T, method: U, args: T[U] extends TypedContractMethod<infer Args extends any[], any, any> ? Args | [...Args, Overrides | undefined] : never, domain?: string) => TransactionMethods<ContractMethodReturnType<T, U>>;

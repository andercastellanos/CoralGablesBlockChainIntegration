...
class OpenSeaSDK {
    ...
    async wrapEth({ amountInEth, accountAddress, }) {
        ...
        const value = (0, ethers_1.parseEther)(ethers_1.FixedNumber.fromValue(amountInEth).toString());
    ...
    async unwrapWeth({ amountInEth, accountAddress, }) {
        await this._requireAccountIsAvailable(accountAddress);
        const amount = (0, ethers_1.parseEther)(ethers_1.FixedNumber.fromValue(amountInEth).toString());
